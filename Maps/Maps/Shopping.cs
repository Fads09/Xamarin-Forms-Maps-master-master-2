...
namespace Maps
{
    public class Shopping : ContentPage
    {
        Map map;
        ...
        public Shopping()
        {
            ...
            var uri = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=32.754795,-97.331384&radius=400&type=store&key=AIzaSyCoR5KG31h_taL3kdyPqEHeciZMe5_1R50";
