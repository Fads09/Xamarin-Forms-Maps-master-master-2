...
namespace Maps
{
    public class Entertainment : ContentPage
    {
        Map map;
        ...
        public Entertainment()
        {
            ...
            var uri = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=32.754795,-97.331384&radius=400&type=entertainment&key=AIzaSyCoR5KG31h_taL3kdyPqEHeciZMe5_1R50";
